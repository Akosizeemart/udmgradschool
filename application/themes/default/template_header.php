...
<body>
    <div class="header">
        <div class="logo">
            <a href="#">
                <img src="<?php echo BASE_FOLDER . 'application/themes/default/themes-images/LOGOUDM.jpg';?>" width="700px" height="115px">
            </a>
        </div>
        <div class="user logout"><a href="<?php echo url('login/member_logout'); ?>">Logout</a></div>
        <div class="user">Logged in as <?php echo $member['name']; ?></a></div>
    </div>
    <!-- <div class="span9"> -->
