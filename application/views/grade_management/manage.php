...
<div id="page">
    ...
    <div class="container float-left">
     ...
     <a class="btn btn-success submit_button" href="javascript:void(0);" onclick="$('#download_student_gradelists_form').submit();"><i class="icon-file icon-white"></i>Download Excel</a>
    </div>
