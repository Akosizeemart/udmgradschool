            ...
            <div id="tab1">
                ...
                <div id="menu-container" class="menu-container float-left" style="width:97%;">
                    ...
                    <div style="float:right;">
                        <div class="btn-group">
                            <a id="open_course_link" class="btn btn-info active" href="javascript:void(0);" onclick="javascript:view_type_filter('open_course');">Open New Subject</a>
